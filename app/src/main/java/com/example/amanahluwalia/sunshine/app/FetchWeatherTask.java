...
import com.example.amanahluwalia.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        long locationId;
        String locationSelectionClause = WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?";
        String[] locationSelectionArgs = {locationSetting};
        String[] locationProjection = {WeatherContract.LocationEntry._ID};
        Cursor locationCursor = mContext.getContentResolver().query(
                WeatherContract.LocationEntry.CONTENT_URI,
                locationProjection,
                locationSelectionClause,
